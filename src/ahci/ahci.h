...
namespace AHCI {
	...
	public:
		...
		Port(HBAPort* hbaPort, PortType portType, uint8_t portNumber) : hbaPort(hbaPort), portType(portType), portNumber(portNumber), buffer(nullptr) {}
	...
	public:
		...
		bool Read(uint64_t sector, uint32_t sectorCount, uint8_t portNumber, void* buffer);
	};
}